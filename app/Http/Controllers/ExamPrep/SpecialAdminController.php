...
class SpecialAdminController extends Controller
{
    ...
    public function manage_exam(){
        ...
        $data['exams']=Oex_exam_master::select(['oex_exam_masters.*','oex_categories.title as cat_name'])->join('oex_categories','oex_exam_masters.category','=','oex_categories.id')->get()->toArray();
    ...
    public function manage_students(){
        ...
        $data['students'] = user_exam::select(['user_exams.*','users.first_name','oex_exam_masters.title as ex_name','oex_exam_masters.exam_date'])
