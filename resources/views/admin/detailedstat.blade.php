    ...
    <table class="table table-bordered">
        ...
        <tr>
            <td class = "profit w-50">
                <p class = "m-0 p-0 mt-2 "><a class = "text-decoration-none text-dark" href = "{{ url('order') }}">Total
                        Sales</a></p>
                <span class = "float-start"><a class = "text-decoration-none text-dark"
                        href = "{{ url('order') }}"><strong>N {{ number_format($totalAmount) }}</strong></a></span>
            ...
            <td class = "w-50 profit">
                <p class = "m-0 p-0 mt-2"><a class = "text-decoration-none text-dark profit"
                        href = "{{ url('order') }}">Order</a></p>
                <span class = "float-start ps-1"><a class = "text-decoration-none text-dark"
                        href = "{{ url('product') }}"><b>{{ $successfulOrders }}</b></a></span>
                <span class = "float-end rounded-5 mb-2 bg-opacity-25 opacity-10 pe-3"
                    style = "font-size: 30px; font-weight:bold; margin-top: -15px;">
