...
@section('admincontent')
    <div class = "row mt-3">
    <div class = "col-sm-4">
    <img src="{{asset('/images/jsce.png')}}" class = "img-fluid mb-2" />
    ...
    <div class = "col-sm-4"><img src="{{asset('/images/ssce.png')}}" class = "img-fluid mb-2" /><span class = "d-block fw-bold fs-sm-5 fs-md-6 fs-lg-7 text-center jss">SSCE Past Questions</span>
    <p class = "p text-md-center">
        Start Studying  with our wide collection of
        all Class Notes for all Terms and all Subjects
        </p>
    ...
    <div class = "col-sm-4"><img src="{{asset('/images/jamb.png')}}"  class = "img-fluid mb-2" /><span class = "d-block fw-bold fs-sm-5 fs-md-6 fs-lg-7 text-center jss">JAMB Past Questions</span>
        <p class = "p text-md-center">
            Start Studying  with our wide collection of
            all Class Notes for all Terms and all Subjects
            </p>
