                    ...
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdown01">
                                ...
                                <li><x-nav-link type="drop" href="/parentresources"
                                        active="{{ request()->is('parentresources') }}">Guidance and
                    ...
                    <form method="POST" action="{{ route('pay') }} " accept-charset="UTF-8" id = "#success"
                        ...
                        <div class="mb-3">
                            ...
                            <select name="plan" id="" class="form-select form-select-sm"
                                ...
                                <option value="call">60 minutes telephone interactive discussion with our Expert</option>
                                <option value="whatsapp">60 minutes Whatsapp conversation</option>
                                <option value="face2face">Face to Face counselling at The Rise Labs</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="hidden" class="form-control" name="currency" value="NGN"
                                placeholder="Naira" readonly />
